...
from PerformanceMap.h5_utils import *
from PerformanceMap.render_loaded import RenderLoaded
from PerformanceMap.perfmap import *
from PerformanceMap.get_img_url import scrape_image_links
...
if __name__ == "__main__":
    ...
    name = 'load300_n3000'
    h5dir = 'PerformanceMap/h5files'
    save_hdf5_filename = os.path.join(h5dir, f'{name}.h5')
    render_mode = None

    # # # # # Number of episodes and steps per episode
    total_episodes = 3000 # about 30% terminate (connected structures)
    ...
    #     render_dir = os.path.join("PerformanceMap/render_perf/",name) # render_mode != "rgb_end"
    # else:
    #     render_dir = os.path.join("PerformanceMap/render_perf/",name) # not used but required
    ...
    # umap_n_neighbors = 7 # low n_neighbor preserves local, high n_neighbor preserves global structure, default is 15
    ...
    # dbscan_num_core = 4 # high n_core creates strict requirement for points to be defined as cluster 
    ...
    render_dir = os.path.join("PerformanceMap/render_perf/", name) 
    ...
    idx_imgurl_dir = 'PerformanceMap/idx_imgurl_csv'
