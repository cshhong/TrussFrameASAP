'''
This script tests the bijective mapping for converting observations and actions from vector values to scalar to fit the Discrete space of gymnasium.
* migrated from TrussFrameASAP-RL 
'''
from cantileverenv_convert_gymspaces import ObservationBijectiveMapping, ActionBijectiveMapping, ObservationDownSamplingMapping
